...
def create_app():
    ...
    with gr.Blocks(title="Maestro - AI 创作平台", css=CUSTOM_CSS) as app:
        ...
        with gr.Column(visible=True, elem_id="home-page") as home_page:
            ...
            <div style="text-align: center; padding: 60px 20px 40px 20px;">
                ...
                <p style="font-size: 1.8rem; font-weight: bold; background: linear-gradient(90deg, #6366f1 0%, #a855f7 35%, #ec4899 70%, #ef4444 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; color: transparent; margin-bottom: 10px;">Melody-Image Symbiosis</p>
            ...
            with gr.Row(equal_height=True, elem_id="module-cards"):
                ...
                with gr.Column(scale=1):
                    ...
                    """)
                    video_enter_btn = gr.Button("🎬 进入视频生成", variant="primary", size="lg", elem_id="video-enter-btn")
                ...
                with gr.Column(scale=1):
                    ...
                    """)
                    avatar_enter_btn = gr.Button("🎼 进入 Avatar", variant="primary", size="lg", elem_id="avatar-enter-btn")
        ...
        with gr.Column(visible=False, elem_id="avatar-page") as avatar_page:
            ...
            with gr.Tabs() as avatar_function_tabs:
                ...
                # 单人说话视频
                with gr.TabItem("🎤 单人说话", id="single_avatar"):
                    with gr.Row():
                        with gr.Column(scale=1):
                ...
                # 双人对话视频
                with gr.TabItem("👥 双人对话", id="multi_avatar"):
                    with gr.Row():
                        with gr.Column(scale=1):
